...
def chiose_radio(radio, system):
    mark_ = gr.Markdown(
        value=f"<center><font size=8>Qwen2.5-Coder-{radio}-instruct👾</center>"
    )
...
def main():
    ...
    with gr.Blocks() as demo:
        with gr.Row():
            ...
            with gr.Row():
                radio = gr.Radio(
                    choices=options_coder, label="Qwen2.5-Coder：", value="32B"
                )

        with gr.Row():
            with gr.Accordion():
                mark_ = gr.Markdown(
                    """<center><font size=8>Qwen2.5-Coder-32B-Instruct Bot👾</center>"""
                )
                with gr.Row():
                ...
                with gr.Accordion("Parameters", open=False):
                    ...
                    top_p = gr.Slider(
                        minimum=0.6, maximum=1.0, value=0.9, step=0.05, label="Top P"
                    )
                ...
                clear_history.click(
                    fn=clear_session, inputs=[], outputs=[textbox, chatbot]
                )
                modify_system.click(
